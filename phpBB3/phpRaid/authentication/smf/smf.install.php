...
defined('_VALID_SETUP') or die('Resricted Access');

include(RAIDER_BASE_PATH.'authentication'.DIRECTORY_SEPARATOR.'smf'.DIRECTORY_SEPARATOR.'smf.configure.php');
...
if($count == 0)
	$output .= '<strong>THE FIRST USER TO VISIT PHPRAIDER AFTER LOGGING INTO SMF WILL BE SET AS AN ADMINISTRATOR!!!</strong><br><br>';
