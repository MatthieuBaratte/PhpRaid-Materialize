...
if(empty($task) || $task == '') {
	...
	if(!defined("DISALLOW_GAME_INSTALL"))
		//$p->assign('installGame_text','<a class="btn btn--input btn--bg" href="index.php?option=com_configuration&amp;task=install_game"><i class="material-icons md-20">file_upload</i>  <i class="material-icons md-20">fiber_new</i></a>');
		$p->assign('installGame_text','"index.php?option=com_configuration&amp;task=install_game"');
