...
if(empty($task) || $task == '') {
	...
	$report->addOutputColumn('location', $pLang['location'],'text-center','text-left','null', 'null', null, null);
	$report->addOutputColumn('officer', $pLang['officer'],'text-center hidden-sm-down','text-center hidden-sm-down', 'null', 'null', null, '__NOLINK__');
	$report->addOutputColumn('date', $pLang['date'],'text-center','text-center', 'null', 'null', null, '__NOLINK__');
	$report->addOutputColumn('invite_time', $pLang['invite_time'],'text-center hidden-sm-down','text-center hidden-sm-down', 'null', 'null', null, '__NOLINK__');
	$report->addOutputColumn('start_time', $pLang['start_time'],'text-center','text-center', 'null', 'null', null, '__NOLINK__');
